package com.example.gifth.screens

import android.annotation.SuppressLint
import androidx.activity.viewModels
import androidx.compose.foundation.Image
import androidx.compose.foundation.layout.*
import com.example.gifth.R
...
fun Login(navController: NavController) {
    ...
    Scaffold(
        topBar = { TopBar(pageName = "EyPuta", navController = navController, backbutton = false) },
        ...
        Column(
            ...
            Image(modifier = Modifier.fillMaxWidth(), contentScale = ContentScale.FillWidth,painter = painterResource(id =
                R.drawable.gifticon), contentDescription = "Banner")
